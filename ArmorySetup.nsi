...
!define URL http://peercoinarmory.com/
...
VIAddVersionKey ProductName "Peercoin Armory"
...
Section -Main SEC0000
    ...
    SetOutPath $DESKTOP
    CreateShortcut "$DESKTOP\Peercoin Armory.lnk" $INSTDIR\ArmoryQt.exe
    !insertmacro CREATE_SMGROUP_SHORTCUT "Peercoin Armory" "$INSTDIR\ArmoryQt.exe" ""
    !insertmacro CREATE_SMGROUP_SHORTCUT "Peercoin Armory (Offline)" "$INSTDIR\ArmoryQt.exe" "--offline"
    !insertmacro CREATE_SMGROUP_SHORTCUT "Peercoin Armory (testnet)" "$INSTDIR\ArmoryQt.exe" "--testnet"
...
Section /o -un.Main UNSEC0000
    !insertmacro DELETE_SMGROUP_SHORTCUT "Peercoin Armory (testnet)"
    !insertmacro DELETE_SMGROUP_SHORTCUT "Peercoin Armory (Offline)"
    !insertmacro DELETE_SMGROUP_SHORTCUT "Peercoin Armory"
    Delete /REBOOTOK "$DESKTOP\Peercoin Armory.lnk"
